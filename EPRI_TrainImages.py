...
model.add(Dense(64))
model.add(Activation('relu'))
model.add(Dropout(0.3))             # was "0.5"
model.add(Dense(num_classes))       # was "1"
...
model.save('EPRIFeb28V1.h5')
model.save_weights('EPRIFeb28V1_try.h5')
